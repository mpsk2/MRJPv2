...
instance Print Program where
  prt i e = case e of
    StandardProgram topdefs -> prPrec i 0 (concatD [prt 0 topdefs])
...
instance Print TopDef where
  prt i e = case e of
    ...
    ClassDef id program -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 program, doc (showString "}")])
    ClassExtDef id1 id2 program -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 program, doc (showString "}")])
    GlobalVar decl -> prPrec i 0 (concatD [prt 0 decl])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Arg where
  prt i e = case e of
    NoInitArg type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Block where
  prt i e = case e of
    ParenBlock stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print Type where
  prt i e = case e of
    ...
    Array type_ expr -> prPrec i 0 (concatD [prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
...
instance Print Expr where
  prt i e = case e of
    EArrayVal exprs -> prPrec i 6 (concatD [doc (showString "{"), prt 0 exprs, doc (showString "}")])
    EArrayAt expr1 expr2 -> prPrec i 6 (concatD [prt 6 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
